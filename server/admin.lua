...
RegisterCommand('drawnow', guarded(function(source, args)
    local gameId = args[1]
...
RegisterCommand('resetdraw', guarded(function(source, args)
...
RegisterCommand('addjackpot', guarded(function(source, args)
...
RegisterCommand('setjackpot', guarded(function(source, args)
...
RegisterCommand('resetjackpot', guarded(function(source, args)
...
RegisterCommand('addmoney', guarded(function(source, args)
...
RegisterCommand('giveticket', guarded(function(source, args)
...
RegisterCommand('removeticket', guarded(function(source, args)
...
RegisterCommand('lotteryreload', guarded(function(source)
