...
lottery_ticket = { name = 'lottery_ticket', label = 'Bilhete de lotaria', weight = 0, type = 'item', image = 'lottery_ticket.png', unique = true, useable = true, shouldClose = true, description = 'Um bilhete de jogo do Centro de Jogos.' },
